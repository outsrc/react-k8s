...
// $FlowFixMe
var RendererContext = React.createContext();
...
function useFela() {
  ...
  var renderer = React.useContext(RendererContext);
...
var ClusterContext = React.createContext(null);
var Namespace = function (_a) {
    ...
    return (React.createElement(ClusterContext.Provider, { value: { emitResource: emitResource } },
        React.createElement("div", { className: css(CLUSTER) }, children)));
};
...
var NamespaceContext = React.createContext('');
...
var Namespace$1 = function (_a) {
    ...
    var css = useFela().css;
    var clusterContext = React.useContext(ClusterContext);
    React.useEffect(function () {
        var _a;
        (_a = clusterContext) === null || _a === void 0 ? void 0 : _a.emitResource("namespace-" + name + ".yml", createNamespaceResource(name));
    }, [name]);
    return (React.createElement(NamespaceContext.Provider, { value: name },
        React.createElement("div", { className: css(NAMESPACE) }, children)));
};

exports.Cluster = Namespace;
